...
- Env vars: `OPENAI_API_KEY`, `SOLANATRACKER_API_KEY`, optional `OPENAI_RESPONSES_MODEL` (default `gpt-5-mini` in `ai/gptClient.js`), `WARLORDAI_VECTOR_STORE` (uploads + RAG retrieval), `NODE_ENV`, `BOOTYBOX_SQLITE_PATH`.
