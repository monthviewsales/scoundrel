 ...
 * @returns {{ winRate:number|null, medianExitPct:number|null, p75ExitPct:number|null, medianHoldMins:number|null, spikeDays:Array<{date:string|null,pnlPct:number}> }}
 */
function computeOutcomesFromMintMap(mintMap, chart){
  ...
  return { winRate, medianExitPct, p75ExitPct, medianHoldMins, spikeDays };
}
