...
/**
 * @deprecated
 * Legacy console-based HUD renderer.
 * Replaced by Ink-based HUD in warchestInkApp.js.
 * Kept temporarily for reference / fallback.
 */
 ...
 * @param {import('../warchest/client').WalletState} w
 * @param {Object} opts
 ...
 * @param {Record<string,import('../warchest/client').WalletState>} state
