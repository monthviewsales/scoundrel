...
async function executeSwap(payload, tools = {}) {
  ...
  if (!result.dryRun && result.txid) {
    ...
    const monitorContext = {
      ...
      slippagePercent: configPayload.slippagePercent,
      priorityFeeLevel: configPayload.priorityFeeLevel || null,
      txVersion: configPayload.txVersion || null,
      showQuoteDetails: configPayload.showQuoteDetails,
      debugLogging: configPayload.debugLogging,
