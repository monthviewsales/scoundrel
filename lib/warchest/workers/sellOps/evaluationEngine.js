...
async function evaluatePosition({
  ...
  // Controller can log this at debug level when troubleshooting.
  try {
    evaluation.gatesDebug = Array.isArray(qualify.results)
      ? qualify.results.map((g) => buildGateDebugEntry(g, evaluation))
      : [];
  } catch (_) {
