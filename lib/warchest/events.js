...
const DEFAULT_HUD_STATE_PATH = path.join(process.cwd(), 'data', 'warchest', 'hud-state.json');
const DEFAULT_EVENT_PATH = path.join(process.cwd(), 'data', 'warchest', 'tx-events.json');
const DEFAULT_HUD_REFRESH_PATH = path.join(process.cwd(), 'data', 'warchest', 'hud-refresh.json');
