 ...
 */
async function buildTargetScanPayload({ mint, client, artifacts, runId, forceTokenRefresh }) {
    ...
    if (mint) {
      try {
        ...
        if (typeof BootyBox.addUpdateTarget === 'function') {
          existingTarget = typeof BootyBox.getTarget === 'function' ? BootyBox.getTarget(mint) : null;
