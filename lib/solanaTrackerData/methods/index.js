...
const { createGetTokensByVolumeWithTimeframe } = require('./getTokensByVolumeWithTimeframe');
...
const { createGetBasicWalletInformation } = require('./getBasicWalletInformation');
...
const { createGetTokenRiskScores } = require('./getTokenRiskScores');
...
function createDataMethods(deps) {
  return {
    ...
    getTokenRiskScores: createGetTokenRiskScores(deps),
