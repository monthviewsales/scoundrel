...
class WalletManagerV2 {
  ...
  async applyTradeEventToPositions(tradeEvent) {
    // DEPRECATED: recordScTradeEvent() is the single-writer entry point and now also keeps sc_positions in sync.
    // This method remains for transitional compatibility, but callers should not invoke it.
