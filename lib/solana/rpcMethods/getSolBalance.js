...
function extractLamports(payload) {
  ...
  if (typeof payload === 'object') {
    if (typeof payload.value === 'number' || typeof payload.value === 'bigint' || typeof payload.value === 'string') {
    ...
    if (typeof payload.lamports === 'number' || typeof payload.lamports === 'bigint' || typeof payload.lamports === 'string') {
      const innerLamports = extractLamports(payload.lamports);
      if (innerLamports != null) return innerLamports;
    } else if (payload.lamports != null) {
      const innerLamports = extractLamports(payload.lamports);
      if (innerLamports != null) return innerLamports;
    }
