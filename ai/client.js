 ...
 */
async function callResponses({ schema, name = 'scoundrel_job', system, user, model = DEFAULT_MODEL, temperature = 0.1, prompt }) {
  const input = [];
  ...
  const payload = {
    ...
    // temperature, // disabled by design for structured outputs; uncomment if you need slight creativity
  };
